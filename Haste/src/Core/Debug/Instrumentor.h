...
#define CORE_PROFILE_BEGIN_SESSION(name, filepath) ::CORE_Core::Instrumentor::Get().BeginSession(name, filepath)
#define CORE_PROFILE_END_SESSION() ::CORE_Core::Instrumentor::Get().EndSession()
#define CORE_PROFILE_SCOPE_LINE2(name, line) constexpr auto fixedName##line = ::CORE_Core::InstrumentorUtils::CleanupOutputString(name, "__cdecl ");\
											   ::CORE_Core::InstrumentationTimer timer##line(fixedName##line.Data)
